...
<div class="grid">
  <div class="grid__col-md-7 dashboard-header">
    <h1><?= sprintf(lang('application.application_welcome_back'), esc($this->user->firstname ?? '')); ?></h1>
    <small><?= sprintf(lang('application.application_welcome_subline'), esc($messages_new[0]->amount ?? 0), esc($event_count_for_today ?? 0)); ?></small>
  </div>
    ...
    <div class="grid__col-12 update-panel">
      <div class="tile-base">
        <div class="panel-heading red">
          <span class="title red"><?= lang('application.application_update_available'); ?></span>
          <span id="hideUpdate" class="pull-right"><i class="ion-close"></i></span>
        </div>
        <div class="panel-content">
          <h2><a href="<?= base_url('settings/updates'); ?>"><?= lang('application.application_new_update_is_ready'); ?></a></h2>
        </div>
      </div>
    </div>
  <?php endif; ?>
