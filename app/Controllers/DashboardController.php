...
class DashboardController extends BaseController
{
	...
	public function index(?string $year = null)
	{
		...
		$this->view_data['stats'] = $this->models['invoice']->getStatisticForYear($year);
		$this->view_data['stats_expenses'] = $this->models['invoice']->getExpensesStatisticForYear($year);
		$this->view_data['payments'] = $this->models['invoice']->paymentsForMonth($currentYearMonth);

		$this->view_data['paymentsOutstandingMonth'] = $this->models['invoice']->outstandingPayments($currentYearMonth);
		$this->view_data['paymentsOutstanding'] = $this->models['invoice']->outstandingPayments();
		$this->view_data['totalExpenses'] = $this->models['invoice']->totalExpensesForYear($year);
		$this->view_data['totalIncomeForYear'] = $this->models['invoice']->totalIncomeForYear($year);
